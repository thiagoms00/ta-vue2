              ...
              <v-window v-model="tab">
                ...
                <v-window-item value="dados">
                  <v-container>
                    ...
                    <v-row class="my-4">
                      <v-row>
                        <template v-for="(habilidade, index) in item.listaDeHab['Lingua Portuguesa']" :key="index">
                          <v-col v-if="habilidade.tentativas !== 0" cols="12" sm="4" class="py-1">
                            <v-list-item>
                              <v-chip :color="getChipColor(habilidade.porcentagemAcertos, habilidade.tentativas)">
                              ...
                              <span class="text-caption ml-2">
                                ...
                                {{
                                  Number.isInteger(habilidade.porcentagemAcertos) ? habilidade.porcentagemAcertos + "% de taxa de acertos" : habilidade.porcentagemAcertos.toFixed(2) + "% de taxa de acertos"
                                }}
                              </span>
                            </v-list-item>
                          </v-col>
                      ...
                      <tbody>
                        <tr v-for="(teste, indexTeste) in item.listaDeTestes" :key="teste._id">
                          ...
                          <p v-if="textoPlanilha" class="hover-text">teste</p>
                            ...
                            <div v-if="loginType === 'admin'" class="d-inline-flex">
                              <v-btn variant="text" class="optionButton" @click="
                                ...
                                ">
                                <v-tooltip activator="parent" location="top">Baixar planilha</v-tooltip>
