<template>
  <div class="main-div">
    ...
    <v-container class="fill-height">
      <v-sheet
        class="main-sheet d-flex align-center justify-center flex-column text-center mx-auto px-4 rounded-lg"
        elevation="10"
        rounded-shaped
      ...
      >
        <v-container class="d-flex flex-column align-center">
          ...
          <Megaphone
            :class="{ 'wobble-hor-bottom': animaMega }"
            @click="playAudio()"
          />

          <p class="welcome-text">
            Você vai responder algumas questões de Português.
          </p>
          <p class="welcome-text">
            Ouça a orientação do que deve ser feito no início de cada questão.
          </p>
          <p class="welcome-text">
            Se quiser ouvir novamente, clique no megafone.
          </p>
          <p class="welcome-text">
            Depois, marque a alternativa que considera correta.
          </p>
          <p class="welcome-text">
            Para seguir em frente, clique em continuar.
          </p>
          <p class="welcome-text">Vamos lá!</p>
          <v-btn
            class="flex-grow-1 mt-4 cont-button"
            :class="{ 'shake-horizontal': animaButton }"
            height="55"
            size="large"
            width="50%"
            variant="flat"
  ...
  methods: {
    proximaPagina() {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url: "https://ta-back.onrender.com/alunos/startTest",
          data: data,
          method: "POST",
        })
          .then((response) => {
            ...
            if (
              localStorage.getItem("idTeste") === null ||
              localStorage.getItem("idTeste") === ""
            ) {
